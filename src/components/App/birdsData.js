const birdsData = [
  [
    ...
    {
      id: 32874,
      name: 'Илья Протько aka Чёрный Ворон',
      species: 'Lisii',
      description: 'Это птица? Это самолёт... Это ИЛЬЯ! Данный вид довольно популярен в наше время, т.к. данный вид трахает всё что движется. На его пути лучше не попадаться',
